...
public class Field extends JButton implements Serializable{
	...
	//----------ADATTAGOK----------
	/**Referencia a mezõn található tárgyra*/
	private Thing thing;												
	/**Referencia a mezõ szomszédjaira adott iránynak megfelelõen.*/
	private HashMap<Direction, Field> neighbors;						
	/**Referencia a mezõ megjelenítése során látható képre/ikonra.*/
