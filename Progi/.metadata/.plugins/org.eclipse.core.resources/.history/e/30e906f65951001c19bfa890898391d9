...
public class MenuFrame extends JFrame{
	...
	/**Referencia a játéktábla megjelenítésére szolgáló osztály példányára.*/
	...
	/**
	 * Figyeli a Játék folytatása feliratú gombot.
	 * */
	 ...
	 * @param f - Az ellenõrzésre kerülendõ fájl neve
	 * @return IGAZ, ha a fájl üres, különben HAMIS.
	 * */
